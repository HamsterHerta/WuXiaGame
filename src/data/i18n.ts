...
export const i18n = {
  ...
  'app.relation.title': { zh: '江湖人脉', en: 'Jianghu Ties' },
  'app.relation.subtitle': { zh: '侠客/各派互动', en: 'Swordsmen & Sects' },
  'app.relation.favor': { zh: '好感', en: 'Favor' },
  'app.relation.rivalry': { zh: '仇恨', en: 'Rivalry' },
  'app.relation.loyalty': { zh: '情义', en: 'Loyalty' },
